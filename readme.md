...
3. Or you can boot into general-pc and use it as start point of your config - make sure it has correct boot.loader.divice (you should change it if using bios, or comment if usign uefi, you can get it from "clean" setup in /etc/nixos/configuration.nix)
